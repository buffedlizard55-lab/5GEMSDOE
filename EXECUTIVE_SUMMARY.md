...
> - **Live Project Webpage:** [https://buffedlizard55-lab.github.io/5GEMSDOE/docs/executive_summary.html](https://buffedlizard55-lab.github.io/5GEMSDOE/docs/executive_summary.html)
...
> **Operational page:** [`docs/submission.html`](https://buffedlizard55-lab.github.io/5GEMSDOE/docs/submission.html) ("Make a submission") is the same path as a checklist — artifact identity re-hashed at build time, the placement table compared against whatever `data/` holds now, the validator table parsed from its own committed log, and every rules sentence quoted by id from `data/evidence/rules_quotes.json` with its verification badge.
...
> **Subpage (added session 20): [How to submit, exactly](https://buffedlizard55-lab.github.io/5GEMSDOE/docs/how_to_submit.html)**
...
> operational page is [submission details](https://buffedlizard55-lab.github.io/5GEMSDOE/docs/submission.html).
...
| **This Repository** | GEMSDOE | [https://github.com/buffedlizard55-lab/5GEMSDOE](https://github.com/buffedlizard55-lab/5GEMSDOE) | Top-leaderboard framework, verified data bridge, and auditable site. |
...
| **GitHub Pages deployment** | Workflow `pages.yml` deploys only from `main` (environment protection). | Maintainer must merge to `main`. | Merge this branch → `main` → site publishes `docs/` to [GitHub Pages](https://buffedlizard55-lab.github.io/5GEMSDOE/docs/index.html). |
...
> Opened as [PR #23](https://github.com/buffedlizard55-lab/5GEMSDOE/pull/23). 288 torch-free tests pass
